...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['admin'])->namespace('Admin')->group(function () {
        ...
        Route::post('mails/{mail}/components/title' , 'MailController@storeComponentTitle')->name('mails.store.component.title');

        Route::post('mails/{mail}/components/button' , 'MailController@storeComponentButton')->name('mails.store.component.button');
        
        Route::post('mails/{mail}/components/text' , 'MailController@storeComponentText')->name('mails.store.component.text');

        Route::post('mails/{mail}/components/image' , 'MailController@storeComponentImage')->name('mails.store.component.image');
        
        Route::post('mails/{mail}/components/logo' , 'MailController@storeComponentlogo')->name('mails.store.component.logo');
