...
class MailManagementTest extends TestCase
{
     ...
     * @test
     */
    public function add_component_related_with_mail()
    {
        ...
        $response =  $user->post("mails/{$mail->id}/components" , [

            'content'=>"Rahma is the best"

        ]);


        $response->assertJson([
            'message'=>'un composant est créé avec succès'
        ]);
